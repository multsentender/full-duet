...
const AdminCard = ({
    ...
    return (
        <div className="admin-card">
            ...
            <div className="admine-card__info">
                {title && (
                    <h4>{title}</h4>
                )}
                {manuf && (
